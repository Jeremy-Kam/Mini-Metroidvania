...
public class BossSmallBullet : MonoBehaviour
{
    ...
    void Start()
    {
        // will always shoot towards player
        rb.AddForce((FindObjectOfType<Player>().transform.position - this.transform.position).normalized * bulletSpeed, ForceMode2D.Impulse);
